...
class Tile(models.Model):
    ...
    terrain_type = models.CharField(
        max_length=20, choices=TerrainType.choices, default=TerrainType.WATER
    )
...
class StartingVehicle(models.Model):
    ...
    vehicle_type = models.CharField(
        max_length=20, choices=VehicleType.choices, default=VehicleType.TANK
    )
...
class PlayerVehicle(models.Model):
    ...
    player_state = models.ForeignKey(
        PlayerLevelState, on_delete=models.CASCADE, related_name="vehicles"
    )
